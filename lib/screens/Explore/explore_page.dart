    ...
    return Column(
      children: <Widget>[
        ...
        SingleChildScrollView(
          ...
          child: Row(
            children: <Widget>[
              tagBuild('Trending Events', Colors.pink, context),
              tagBuild('Deals', Colors.blue, context),
              tagBuild('Performers Wanted', Colors.orange, context),
              tagBuild('Employment Opportunities', Colors.red, context),
